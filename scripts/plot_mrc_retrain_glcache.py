...
if __name__ == "__main__":
    ...
    for algo in ap.algos.split(","):
        ...
        mrc_dict[algo+"-half-day"] = run_cachesim_time_custom(
            ap.tracepath,
            algo,
            ap.size,
            ap.ignore_obj_size,
            ...
            ap.trace_format_params,
            ap.num_thread,
            # retrains every half day
            retrain_duration=86400/2
        )
        ap.algos = "gl-cache-every-day,gl-cache-no-retrain,gl-cache-half-day"
